...
class encoder:
    def cargarjson(self):
        with open('PRACTICOS/Practico Tkinter/iteracion 3/sin canvas/pysimonpuntajes.json',mode='r') as lect:
            try:
    ...
    def agregarajson(self,jugadores):
        with open('PRACTICOS/Practico Tkinter/iteracion 3/sin canvas/pysimonpuntajes.json', mode='w') as guard:
