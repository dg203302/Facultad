...
class docente_investigador(investigador,docente):
    __sueldo:float
    def __init__(self, nombre, apellido, dni,materiacargo, area, incentivo, cargo, horas_asignadas, sueldo):
        super().__init__(nombre, apellido, dni,materiacargo, area, incentivo, cargo, horas_asignadas, sueldo)
