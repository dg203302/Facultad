...
class simondice(tk.Tk):
    ...
    def mostrarpuntajes(self):
        if self.__gestorjugadores.verificjson()==False:
            ...
            self.__menucontextual = ttk.Treeview(self.__ventanamuestra, columns=("Jugador", "Fecha", "Hora", "Puntaje", "Dificultad"), show='headings')
            ...
            self.__menucontextual.heading('#5',text='dificultad')
